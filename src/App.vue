  ...
  <div class="study-timer">
    ...
    <div class="tree-area">
      ...
      <div class="tree">
        ...
        <img src="./assets/pngtree-tree-forest-tree-png-image_14619746-removebg-preview.png" alt="Study Tree" class="tree-img">
...
.leaf-pixel {
  ...
  width: 20px;
  height: 20px;
  background-image: url('./assets/download-removebg-preview.png');
